...
public class RKSolver implements StepInterface {
    ...
    public StateInterface step(ODEFunctionInterface f, double t, StateInterface y, double h) {
        ...
        State nexState = new State(r1.mul(0.5).add(stateRate).getPosRates(), r1.mul(0.5).add(stateRate).getVelRates(), t + 0.5*h); //w+k1/2
        Rate r2 = ((Rate) f.call(t + 0.5 * h, nexState)).mul(h);        //k2=h*f(t+h/2,w+k1/2);

        State nexState2 = new State(r2.mul(0.5).add(stateRate).getPosRates(), r2.mul(0.5).add(stateRate).getVelRates(), t + 0.5*h); //w+k2/2
        Rate r3 = ((Rate) f.call(t + 0.5 * h, nexState2)).mul(h);         //k3 = h*f(t+h/2,w+k2/2);

        State nexState3 = new State(r3.add(stateRate).getPosRates(), r3.add(stateRate).getVelRates(), t + h); //w+k3
        ...
        return new State(w.getPosRates(), w.getVelRates(), t + h);
...
class RK2 implements StepInterface{
    ...
    public StateInterface step(ODEFunctionInterface f, double t, StateInterface y, double h) {
        ...
        State nexState = new State(r1.mul(1.0/3.0).add(stateRate).getPosRates(), r1.mul(1.0/3.0).add(stateRate).getVelRates(), t + h/3.0); //w+k1/3
        Rate r2 = ((Rate) f.call(t + h/3.0, nexState)).mul(h);        //k2=hf(t+h/3,w+k1/3);

        State nexState2 = new State(r1.mul(-1.0/3.0).add(r2).add(stateRate).getPosRates(), r1.mul(-1.0/3.0).add(r2).add(stateRate).getVelRates(), t + 2*h/3.0); //w-k1/3+k2
        Rate r3 = ((Rate) f.call(t + 2 * h/3.0, nexState2)).mul(h);         //k3 = hf(t+2h/3,w-k1/3+k2);

        State nexState3 = new State(r1.add(r2.mul(-1)).add(r3).add(stateRate).getPosRates(), r1.add(r2.mul(-1)).add(r3).add(stateRate).getVelRates(), t + h); //w+k1-k2+k3
