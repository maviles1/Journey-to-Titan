...
//        int x = (150000) / 2; //center
        ...
        LandingState y0 = new LandingState(new Vector3d(x, y, 0), new Vector3d(100, 0, 0), new Vector3d(0,1,0), new Vector3d(1,0,0), wm.getStartingWindVector(y), Math.toRadians(0), 0, 0);
